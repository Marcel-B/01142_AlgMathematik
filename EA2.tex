...
\begin{figure}[h] 
	\centering
    \subfigure[$G_1$]{\scalebox{.7}{\input{EA2_Abb6}}} 
	\hspace{1cm}
    \subfigure[$G_2$]{\scalebox{.7}{\input{EA2_Abb7}}} 
	\hspace{1cm}
	\subfigure[$G_3$]{\scalebox{.7}{\input{EA2_Abb8}}}
...
\begin{figure}[h] 
	\centering
    \subfigure[$G_4$]{\scalebox{.7}{\input{EA2_Abb9}}} 
	\hspace{1cm}
    \subfigure[$G_5$]{\scalebox{.7}{\input{EA2_Abb10}}} 
	\hspace{1cm}
	\subfigure[$G_6$]{\scalebox{.7}{\input{EA2_Abb11}}}
%\caption{Titel unterm gesamten Bild} 
\end{figure} 
...
\begin{figure}[h] 
	\centering
    \subfigure[$G_7$]{\scalebox{.7}{\input{EA2_Abb12}}} 
	\hspace{2.5cm}
    \subfigure[$G_8$]{\scalebox{.7}{\input{EA2_Abb13}}} 
\end{figure} 


\begin{figure}[h] 
	\centering
    \subfigure[$G_9$]{\scalebox{.7}{\input{EA2_Abb14}}} 
	\hspace{2.5cm}
    \subfigure[$G_10$]{\scalebox{.7}{\input{EA2_Abb15}}} 
\end{figure} 
