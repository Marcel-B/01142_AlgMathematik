...
\begin{figure}[h]
	\centering
	\scalebox{.3}{\input{EA2_Abb13}}
	\caption{$G_8$} 
	\label{img:grafi-dmmmm}
\end{figure}

\begin{figure}[h]
	\centering
	\scalebox{.3}{\input{EA2_Abb14}}
	\caption{$G_9$} 
	\label{img:grafi-dmmolo}
\end{figure}

\begin{figure}[h]
	\centering
	\scalebox{.3}{\input{EA2_Abb15}}
	\caption{$G_{10}$} 
